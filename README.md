...
X-10A42V-DDSB-PSU is a dual in one PSU circuit module in one double-sided circuit board designed to supply the operating voltage for power amplifier main-circuit module such as [X-B120W-4](https://github.com/X-ANONYMOUS-POWER-AMPLIFIER/X-B120W-4). It provides split dual 42V DC symmetrical outputs with 10A DC current handling capability applies GBU1006 rectifier diodes. This PSU circuit module provides advanced groundings specialized for power amplifier as: audio grounds, power/PSU grounds, and chassis grounds. It is completed with inrush current limiter applies 7 ohms - 15 Amperes Inrush Current Limiter (NTC Thermistor) type MS32-7R015 product from Vishay / Ametherm.
